package com.example.xc.myapp.util;
...
public class FileUtils {
	 ...
	 * 保存文件的目录名
	 */
	private final static String FOLDER_NAME = "/xc";

	private final static String File_Name="MyLocationInfo.txt";
	...
	public static File  createFile(){
		File file=new File(getStorageDirectory()+"/"+File_Name);
		if(file.exists()){
			return file;
		}else{
			try {
